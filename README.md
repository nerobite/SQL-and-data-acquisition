...
UPD: Загрузил все домашки по курсу, финальный проект второй версии доработанный и добавлены дополнительные задания с другого потока, которых в моем потоке не было. 

UPD 2: Добавил домашки по "**Продвинутому SQL**"

UPD 3: Добавил новую итоговую работу по курсы "**SQL и получение данных**" начиная с 17.04.2025
